...
- 💼 Atualmente atuando como Desenvolvedor Web na **Secretaria Municipal de Educação de Parnamirim/RN**.
- 🎓 Graduando em Ciência e Tecnologia pela **Universidade Federal do Rio Grande do Norte (UFRN)**.
- 🤖 Tenho implementado soluções envolvendo **Visão Computacional (YOLO)** e Inteligência Artificial.
- 🥋 Fora dos códigos, sou atleta competidor de Jiu-Jitsu.
